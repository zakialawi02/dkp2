...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link <?= uri_string() === 'peta' ? 'active' : '' ?>" href="<?= url_to('petaKesesuaian') ?>">
        ...
        <?php if (in_groups('User')) : ?>
            <li class="nav-item">
                <a class="nav-link <?= uri_string() === 'dashboard/ajuan-saya' ? 'active' : '' ?>" href="<?= url_to('admin.mySubmission'); ?>">
        ...
        <?php if (in_groups('SuperAdmin') || in_groups('Admin')) : ?>
            ...
            <li class="nav-item">
                ...
                <ul class="nav-content collapse" id="ruang-laut-nav" data-bs-parent="#sidebar-nav">
                    <li>
                        <a class="<?= uri_string() === 'dashboard/data/permohonan/disetujui' ? 'active' : '' ?>" href="<?= url_to('admin.permohonan.disetujui'); ?>">
                            <i class="bi bi-circle"></i><span>Permohonan Disetujui Semua</span>
                        </a>
                    </li>
                    <li>
                        <a class="<?= uri_string() === 'dashboard/data/permohonan/disetujui-tanpa-lampiran' ? 'active' : '' ?>" href="<?= url_to('admin.permohonan.disetujuiTnpLampiran'); ?>">
                            <i class="bi bi-circle"></i><span>Permohonan Disetujui Tanpa Lampiran</span>
                        </a>
                    </li>
                    <li>
                        <a class="<?= uri_string() === 'dashboard/data/permohonan/disetujui-dengan-lampiran' ? 'active' : '' ?>" href="<?= url_to('admin.permohonan.disetujuiDgLampiran'); ?>">
                            <i class="bi bi-circle"></i><span>Permohonan Disetujui Dengan Lampiran</span>
                        </a>
                    </li>
                    <li>
                        <a class="<?= uri_string() === 'dashboard/data/permohonan/tidak-disetujui' ? 'active' : '' ?>" href="<?= url_to('admin.permohonan.tidakDisetujui'); ?>">
                            <i class="bi bi-circle"></i><span>Permohonan Tidak Disetujui</span>
                        </a>
                    </li>
                </ul>
            </li>
            <a class="nav-link <?= uri_string() === 'dashboard/data/permohonan/masuk' ? 'active' : '' ?>" href="<?= url_to('admin.permohonan.masuk') ?>">
