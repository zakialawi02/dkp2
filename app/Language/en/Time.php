...
return [
    ...
    'invalidMonth'   => 'Month must be between 1 and 12. Given: "{0}"',
    'invalidDay'     => 'Day must be between 1 and 31. Given: "{0}"',
    'invalidOverDay' => 'Day must be between 1 and "{0}". Given: "{1}"',
    'invalidHours'   => 'Hour must be between 0 and 23. Given: "{0}"',
